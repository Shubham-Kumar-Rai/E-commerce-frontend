    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[220px] sm:h-[350px] md:h-[450px] lg:h-[600px] overflow-hidden">
        ...
        <Button
          ...
          className="absolute top-1/2 left-2 sm:left-4 transform -translate-y-1/2 bg-white/80 p-2 sm:p-3"
        >
        ...
        <Button
          ...
          className="absolute top-1/2 right-2 sm:right-4 transform -translate-y-1/2 bg-white/80 p-2 sm:p-3"
        >
